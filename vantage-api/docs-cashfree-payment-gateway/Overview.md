...
To get started, include the cashfree.js library in your website. To be PCI compliant, you must load cashfree.js directly from [https://sdk.cashfree.com](https://sdk.cashfree.com/). You cannot include it in a bundle or host it yourself. To always use a specific version you will have to include the version in this way:

Copy  
Ask AI  
\<script src\="https://sdk.cashfree.com/js/v3/cashfree.js"\>\</script\>

If you’re using Svelte or React, refer to the [SDK documentation](https://www.cashfree.com/docs/payments/online/element/sdks#svelte-library) for more details.
...
### [**​**](https://www.cashfree.com/docs/payments/online/element/sdks#js-library)
...
### [**​**](https://www.cashfree.com/docs/payments/online/element/sdks#svelte-library)
...
### [**​**](https://www.cashfree.com/docs/payments/online/element/sdks#react-library)
...
Yes  
No  
[Overview](https://www.cashfree.com/docs/payments/online/element/overview)  
...
## [**​**](https://www.cashfree.com/docs/payments/online/element/introduction#cashfree-js)
...
## [**​**](https://www.cashfree.com/docs/payments/online/element/introduction#checkout)

## checkout()

The checkout method redirects the user to a Cashfree hosted page. See all the supported options [here](https://www.cashfree.com/docs/payments/online/element/payment-options#configuring-payment-options). You can find a full example [here](https://www.cashfree.com/docs/payments/online/element/examples)
...
let checkoutOptions \= {  
	...
	returnUrl:  
		"https://test.cashfree.com/pgappsdemos/v3success.php?myorder={order\_id}",  
};  
...
## [**​**](https://www.cashfree.com/docs/payments/online/element/introduction#create)
...
Here is a small example demonstrating how to render a UPI collect component. We will see more detailed example in the UPI collect [example](https://www.cashfree.com/docs/payments/online/element/examples#upi-collect).

Refer to [this page](https://www.cashfree.com/docs/payments/online/element/upi) for all available components
...
create takes two arguments. The first argument is the component name of type string. You can find all the names of the components we provide [here](https://www.cashfree.com/docs/payments/online/element/upi).

The second argument is of type object. It contains details about the behavior and look of the component. Find all the details for options object [here](https://www.cashfree.com/docs/payments/online/element/customize)

##### Returns

An instance of the component. A component has several methods that you can find [here](https://www.cashfree.com/docs/payments/online/element/overview)

---

## [**​**](https://www.cashfree.com/docs/payments/online/element/introduction#mount)
...
## [**​**](https://www.cashfree.com/docs/payments/online/element/introduction#pay)

## pay()

Use pay() to begin payment flow for a component. Not all components are payable. Check all the components [here](https://www.cashfree.com/docs/payments/online/element/other-components). The pay method takes in a [paymentOption](https://www.cashfree.com/docs/payments/online/element/payment-options) object.
...
let paymentOptions \= {  
	...
	paymentSessionId: "your-payment-session-id",  
	returnUrl: "https://example.com?order={order\_id}",  
};  
cashfree.pay(paymentOptions).then(function (result) {  
	...
	if (result.paymentDetails) {  
		//only when redirect \= 'if\_required' for UPI payment  
		//payment is successful  
		//message is at result.paymentDetails.paymentMessage  
	}  
});

You can read more about payment options and their configuration [here](https://www.cashfree.com/docs/payments/online/element/payment-options)

##### Returns

cashfree.pay will return a Promise.

Upon success, the promise will resolve with result.paymentMessage if the user has opted for a non redirection flow. example UPI, QR. Upon redirection, the promise will resolve with result.redirect If the payment fails, the Promise will resolve with an result.error. error.type will describe the failure. In some cases you can directly show the error.message to your user. Please refer [here](https://www.cashfree.com/docs/api-reference/payments/errors) for the types
...
Yes  
No  
[SDK Libraries](https://www.cashfree.com/docs/payments/online/element/sdks)  
